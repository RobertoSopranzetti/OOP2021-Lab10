...
public final class LambdaFilter extends JFrame {
	...
	private enum Command {
		...
		IDENTITY("No modifications", Function.identity()), TO_LOWER("Lowercase", String::toLowerCase),
		...
		WORDS("Sort words in alphabetical order",
				s -> Arrays.stream(s.split(ANY_NON_WORD)).sorted().collect(Collectors.joining("\n"))),
